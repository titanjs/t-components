...
Ripple.prototype.view = __dirname;
...
Ripple.prototype.setupCanvas = function () {
...
Ripple.prototype.downAction = function (e) {
  this.setupCanvas();
...
Ripple.prototype.upAction = function () {
...
Ripple.prototype.cancel = function () {
  this.cancelled = true;
}

Ripple.prototype.animate = function (ctx) {
...
// INK EQUATIONS
//
Ripple.prototype.waveRadiusFn = function (touchDownMs, touchUpMs, anim) {
...
Ripple.prototype.waveOpacityFn = function (td, tu, anim) {
  // Convert from ms to s.
...
Ripple.prototype.waveOuterOpacityFn = function (td, tu, anim) {
  // Convert from ms to s.
  var touchDown = td / 1000;
  var touchUp = tu / 1000;
...
Ripple.prototype.waveDidFinish = function (wave, radius, anim) {
...
Ripple.prototype.waveAtMaximum = function (wave, radius, anim) {
  var waveOpacity = this.waveOpacityFn(wave.tDown, wave.tUp, anim);
...
// DRAWING
//
Ripple.prototype.drawRipple = function (ctx, x, y, radius, innerColor, outerColor) {
  if (outerColor) {
...
// SETUP
//
Ripple.prototype.createWave = function (elem) {
...
Ripple.prototype.removeWaveFromScope = function (scope, wave) {
  if (scope.waves) {
...
Ripple.prototype.cssColorWithAlpha = function (cssColor, alpha) {
...
Ripple.prototype.dist = function (p1, p2) {
  return Math.sqrt(this.pow(p1.x - p2.x, 2) + this.pow(p1.y - p2.y, 2));
}

Ripple.prototype.distanceFromPointToFurthestCorner = function (point, size) {
