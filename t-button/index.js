...
Button.prototype.view = __dirname;
...
Button.prototype.insideButton = function (x, y) {
  var rect = this.wrapper.getBoundingClientRect();
  return (rect.left <= x) && (x <= rect.right) && (rect.top <= y) && (y <= rect.bottom);
};

Button.prototype.adjustZ = function () {
...
Button.prototype.downAction = function(e) {
  this.lastEvent = e;
...
Button.prototype.upAction = function(e) {
...
Button.prototype.focusAction = function() {
  if (!this.model.get('pressed')) {
    this.model.set('focused', true);
  }
};

Button.prototype.blurAction = function() {
  this.model.set('focused', false);
};

Button.prototype.clickAction = function(e, el) {
  this.emit('click', e, el, this.model.get('item'));
};

Button.prototype.dblClickAction = function(e, el) {
  this.emit('dblclick', e, el, this.model.get('item'));
};

Button.prototype.contextMenuAction = function(e, el) {
